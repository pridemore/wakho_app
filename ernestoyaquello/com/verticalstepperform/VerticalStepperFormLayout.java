package com.pamsillah.samsure.ernestoyaquello.com.verticalstepperform;
...
public class VerticalStepperFormLayout extends RelativeLayout implements View.OnClickListener {
    ...
    protected void init(Context context) {
        ...
        mInflater.inflate(ernestoyaquello.com.verticalstepperform.R.layout.vertical_stepper_form_layout, this, true);
    }
    ...
    public void setStepAsCompleted(int stepNumber) {
        ...
        RelativeLayout stepHeader = (RelativeLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_header);
        ImageView stepDone = (ImageView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_done);
        TextView stepNumberTextView = (TextView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_number);
        LinearLayout errorContainer = (LinearLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.error_container);
        TextView errorTextView = (TextView) errorContainer.findViewById(ernestoyaquello.com.verticalstepperform.R.id.error_message);
        AppCompatButton nextButton = (AppCompatButton) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.next_step);
    ...
    protected void setUpStep(int stepNumber) {
        ...
        if (stepNumber < numberOfSteps) {
            ...
            RelativeLayout stepContent = (RelativeLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_content);
    ...
    protected void setUpStepLayoutAsConfirmationStepLayout(LinearLayout stepLayout) {
        LinearLayout stepLeftLine = (LinearLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.vertical_line);
        LinearLayout stepLeftLine2 = (LinearLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.vertical_line_subtitle);
        confirmationButton = (AppCompatButton) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.next_step);
        ...
        confirmationButton.setText(ernestoyaquello.com.verticalstepperform.R.string.vertical_form_stepper_form_confirm_button);
    ...
    protected LinearLayout createStepLayout(final int stepNumber) {
        ...
        LinearLayout circle = (LinearLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.circle);
        ...
        TextView stepTitle = (TextView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_title);
        ...
        if(stepsSubtitles != null && stepNumber < stepsSubtitles.size()) {
            ...
            if(subtitle != null && !subtitle.equals("")) {
                stepSubtitle = (TextView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_subtitle);
        ...
        TextView stepNumberTextView = (TextView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_number);
        stepNumberTextView.setText(String.valueOf(stepNumber + 1));
        stepNumberTextView.setTextColor(stepNumberTextColor);

        ImageView stepDoneImageView = (ImageView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_done);
        stepDoneImageView.setColorFilter(stepNumberTextColor);

        TextView errorMessage = (TextView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.error_message);
        ImageView errorIcon = (ImageView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.error_icon);
    ...
    protected LinearLayout generateStepLayout() {
        ...
        return (LinearLayout) inflater.inflate(ernestoyaquello.com.verticalstepperform.R.layout.step_layout, content, false);
    }
    ...
    protected void findViews() {
        content = (LinearLayout) findViewById(ernestoyaquello.com.verticalstepperform.R.id.content);
        stepsScrollView = (ScrollView) findViewById(ernestoyaquello.com.verticalstepperform.R.id.steps_scroll);
        progressBar = (ProgressBar) findViewById(ernestoyaquello.com.verticalstepperform.R.id.progress_bar);
        previousStepButton = (AppCompatImageButton) findViewById(ernestoyaquello.com.verticalstepperform.R.id.down_previous);
        nextStepButton = (AppCompatImageButton) findViewById(ernestoyaquello.com.verticalstepperform.R.id.down_next);
        bottomNavigation = (RelativeLayout) findViewById(ernestoyaquello.com.verticalstepperform.R.id.bottom_navigation);
    }
    ...
    protected void disableStepLayout(int stepNumber, boolean smoothieDisabling) {
        ...
        ImageView stepDone = (ImageView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_done);
        TextView stepNumberTextView = (TextView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_number);
        LinearLayout button = (LinearLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.next_step_button_container);
        RelativeLayout stepContent = (RelativeLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_content);
    ...
    protected void displayDoneIconInConfirmationStep() {
        ...
        ImageView stepDone = (ImageView) confirmationStepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_done);
        TextView stepNumberTextView = (TextView) confirmationStepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_number);
        stepDone.setVisibility(View.VISIBLE);
        stepNumberTextView.setVisibility(View.INVISIBLE);
    }
    ...
    protected void setVerticalLineNearSubtitleHeightWhenSubtitleIsGone(LinearLayout stepLayout, int height) {
        TextView stepSubtitle = (TextView) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_subtitle);
        if (stepSubtitle.getVisibility() == View.GONE) {
            LinearLayout stepLeftLine = (LinearLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.vertical_line_subtitle);
    ...
    protected void setHeaderAppearance(LinearLayout stepLayout, float alpha,
        ...
        if(!materialDesignInDisabledSteps) {
            RelativeLayout stepHeader = (RelativeLayout) stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_header);
            TextView title = (TextView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_title);
            TextView subtitle = (TextView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_subtitle);
            LinearLayout circle = (LinearLayout) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.circle);
            ImageView done = (ImageView) stepHeader.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_done);
    ...
    public void onClick(View v) {
        String previousNavigationButtonTag =
                context.getString(ernestoyaquello.com.verticalstepperform.R.string.vertical_form_stepper_form_down_previous);
